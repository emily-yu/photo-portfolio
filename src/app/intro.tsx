      ...
      <section className="profile_container gallerycontainer">
        ...
        <Stack id="aboutMe" className="gallerycontainer">
          <p style={{ paddingBottom: "10px" }}>
            My badminton journey began at Synergy Badminton Academy in Menlo
            Park. As an adult, my love for the game has guided me back to a
            place that I love and to this day, I continue competing while giving
            back to the community I love.{" "}
          </p>
          <p>
            I started taking photos in my spare time at tournaments while
            competing but it quickly grew into something more than that. Since
            then, I’ve worked with USAB events and shot for 10+ tournaments
            across the States, from the Bay Badminton Championships in Milpitas,
            CA to the Riaan New Jersey Open in New Jersey, NJ.
          </p>
          <FatQuote text="It may just be a hobby for you, but it is memories for us." />
          <p style={{ paddingTop: "20px", paddingBottom: "20px" }}>
            If you’re running a tournament, I’d love to work with you to capture
            your moments. I look forward to hearing from you - for projects, for
            feedback, or even just to talk badminton.
          </p>
        </Stack>
      </section>
    </>
